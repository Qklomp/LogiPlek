...
<div class="col-lg-8 col-lg-offset-2">
    <div class="panel panel-default">
            ...
            <fieldset>
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="has-feedback <?php echo (form_error('autonummer') !== '') ? 'has-error' : '' ?>">
                                <label for="autonummer" class="control-label">Autonummer <span
                                            class="text-danger">*</span></label>
                                <input type="text" class="form-control input-sm" name="autonummer"
                                       placeholder="Autonummer" value="<?php echo $auto['autonummer'] ?>" required
                            ...
                            <div class="has-feedback <?php echo (form_error('kenteken') !== '') ? 'has-error' : '' ?>">
                                ...
                                <input type="text" class="form-control input-sm licenseplate" name="kenteken"
                                       placeholder="Kenteken" value="<?php echo $auto['kenteken'] ?>" required
                                       data-parsley-required>
                            </div>

                            <label for="kmstand" class="control-label">Kilometerstand </label>
                            <input type="text" class="form-control input-sm" name="kmstand" placeholder="Kilometerstand"
                                   value="<?php echo $auto['kmstand'] ?>">
                    ...
                    <div class="col-lg-5 col-lg-offset-1">
                        ...
                        <div class="form-group">
                            <h3>Informatie</h3>
                            <p class="form-control-static small">Toegevoegd
                                op <?php echo nl_text_date($auto['toegevoegd_op']) ?>
                                door <?php echo $auto['toegevoegd_door'] ?></p>
                        </div>
                    </div>
                    <!-- END RIGHT -->
                </div>
        ...
        <div class="panel-footer">
            <ul class="list-inline">
                <li><a href="/autos/" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-arrow-left"></i>
                        Terug</a></li>
            </ul>
        </div>
    </div>
