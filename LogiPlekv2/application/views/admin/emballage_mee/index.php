<ol class="breadcrumb" xmlns="http://www.w3.org/1999/html">
    ...
    <li class="active"> Mee Toevoegen</li>
</ol>
...
echo form_open('emballage_mee/aanpassen', $attributes)
?>
            ...
            <div class="col-lg-4">
                <div class="input-group input-group-sm">
                    ...
                    <span class="input-group-addon">
                      <a href="" class="open-deleteAlert" data-id="<?php echo $emballage['id']?>" data-type="emballage_mee" data-toggle="modal" data-target="#deleteAlert"><i class="glyphicon glyphicon-trash"></i></a>
                    </span>
                </div>
            </div>
            <?php endforeach ?>
